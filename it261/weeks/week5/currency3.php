...
<head>
    <meta charset="UTF-8">
    <title>Our Currency 3- Sticky Form</title>
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" 
    ...
    <select name="bank">
        ...
        <?php if(isset($_POST['bank']) && $_POST['bank'] == 'Key Bank') echo 'selected="selected" ' ;?>
        >Key Bank</option>
        <option value="Chase Bank"
        <?php if(isset($_POST['bank']) && $_POST['bank'] == 'Chase Bank') echo 'selected="selected" ' ;?>
        >Chase Bank</option>
        <option value="BECU"
...
<div class="box">
<h2> Hello, '.$name.'!</h2>
<p>You now have $'.$friendly_total.' American dollars, and it will be deposited 
in <b>'.$bank.'</b> and we will email at <b>'.$email.'</b> in the next 24 hours!</p>
</div>
';
